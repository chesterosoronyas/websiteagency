...
export default function Home() {
  ...
  const scrollToGraphicDesign = () => {
    ...
    graphicDesignRef.current?.scrollIntoView({ block:'nearest' ,behavior: "smooth" });
  };

  const scrollToShopifyStores = () => {
    shopifyStoresRef.current?.scrollIntoView({ block:'nearest',behavior: "smooth" });
  };

  const scrollToBrands = () => {
    brandsRef.current?.scrollIntoView({block:'nearest', behavior: "smooth" });
  };
